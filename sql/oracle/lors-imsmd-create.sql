...
create table ims_md_general (
    ims_md_id   integer
                ...
                primary key,
    title_l     varchar2(100),
    title_s     varchar2(1000),
    structure_s varchar2(1000),
    structure_v varchar2(1000),
    agg_level_s varchar2(1000),
    agg_level_v varchar2(1000)
);
...
create sequence ims_md_general_title_seq start with 1;
...
create index ims_md_ge_ti_imd_md_id_idx on ims_md_general_title (ims_md_id);
...
create sequence ims_md_general_iden_seq start with 1;
...
create index ims_md_ge_iden_imd_md_id_idx on ims_md_general_iden (ims_md_id);
...
create sequence ims_md_general_cata_seq start with 1;
...
create table ims_md_general_cata (
    ...
    entry_l     varchar2(100),
    entry_s     varchar2(1000)
);

-- create index for ims_md_general_cata
create index ims_md_ge_cata_imd_md_id_idx on ims_md_general_cata (ims_md_id);
...
create sequence ims_md_general_lang_seq start with 1;
...
create index ims_md_ge_lang_imd_md_id_idx on ims_md_general_lang (ims_md_id);
...
create sequence ims_md_general_desc_seq start with 1;
...
create table ims_md_general_desc (
    ...
    ims_md_id           integer
                        ...
                        references ims_md(ims_md_id)
                        on delete cascade,
    descrip_l           varchar2(100),
    descrip_s           varchar(2000)
);

-- create index for ims_md_general_desc
create index ims_md_ge_desc_imd_md_id_idx on ims_md_general_desc (ims_md_id);
...
create sequence ims_md_general_key_seq start with 1;
...
create table ims_md_general_key (
    ...
    ims_md_id           integer
                        ...
                        references ims_md(ims_md_id)
                        on delete cascade,
    keyword_l           varchar2(100),
    keyword_s           varchar2(1000)
);

-- create index for ims_md_general_key
create index ims_md_ge_key_imd_md_id_idx on ims_md_general_key (ims_md_id);
...
create sequence ims_md_general_cover_seq start with 1;
...
create table ims_md_general_cover (
    ims_md_ge_cove_id   integer
                        ...
                        primary key,
    ims_md_id           integer
                        constraint ims_md_ge_cover_ims_md_id_fk
                        references ims_md(ims_md_id)
                        on delete cascade,
    cover_l             varchar2(100),
    cover_s             varchar2(1000)
);

-- create index for ims_md_general_cover
create index ims_md_ge_cover_imd_md_id_idx on ims_md_general_cover (ims_md_id);
...
create table ims_md_life_cycle (
    ims_md_id   integer
                ...
                primary key,
    version_l   varchar2(100),
    version_s   varchar2(50),
    status_s    varchar2(1000),
    status_v    varchar2(1000)
);
...
create sequence ims_md_life_cycle_contrib_seq start with 1;
...
create table ims_md_life_cycle_contrib (
    ...
    ims_md_id           integer
                        ...
                        references ims_md(ims_md_id)
                        on delete cascade,
    role_s              varchar2(1000),
    role_v              varchar2(1000),
    cont_date           varchar2(200),
    cont_date_l         varchar2(100),
    cont_date_s         varchar2(1000)
);

-- create index for ims_md_life_cycle_contrib
create index ims_md_lf_cont_imd_md_id_idx on ims_md_life_cycle_contrib (ims_md_id);
...
create sequence ims_md_lf_c_contrib_enty_seq start with 1;
...
create sequence ims_md_metadata_cata_seq start with 1;
...
create index ims_md_md_cata_imd_md_id_idx on ims_md_metadata_cata (ims_md_id);
...
create sequence ims_md_metadata_contrib_seq start with 1;
...
create index ims_md_md_cont_imd_md_id_idx on ims_md_metadata_contrib (ims_md_id);
...
create sequence ims_md_meta_contrib_enty_seq start with 1;
...
create table ims_md_metadata_contrib_entity (
    ...
    ims_md_md_cont_id       integer
                            constraint ims_md_metadata_cont_ent_fk
...
create sequence ims_md_metadata_scheme_seq start with 1;
...
create table ims_md_technical (
    ims_md_id       integer
                    ...
                    primary key,
    t_size          varchar2(30),
    instl_rmrks_l   varchar2(100),
    instl_rmrks_s   varchar2(1000),
    otr_plt_l       varchar2(100),
    otr_plt_s       varchar2(1000),
    duration        varchar2(200),
    duration_l      varchar2(100),
    duration_s      varchar2(1000)
);
...
create sequence ims_md_technical_format_seq start with 1;
...
create index ims_md_te_format_imd_md_id_idx on ims_md_technical_format (ims_md_id);
...
create sequence ims_md_technical_location_seq start with 1;
...
create sequence ims_md_tech_requirement_seq start with 1;
...
create table ims_md_technical_requirement (
    ...
    ims_md_id           integer
                        ...
                        references ims_md(ims_md_id)
                        on delete cascade,
    type_s              varchar2(1000),
    type_v              varchar2(1000),
    name_s              varchar2(1000),
    name_v              varchar2(1000),
    min_version         varchar2(30),
    max_version         varchar2(30)
);

-- create index for ims_md_technical_requirement
create index ims_md_te_req_imd_md_id_idx on ims_md_technical_requirement (ims_md_id);
...
create table ims_md_educational (
    ims_md_id       integer
                    ...
                    primary key,
    int_type_s      varchar2(1000),
    int_type_v      varchar2(1000),
    int_level_s     varchar2(1000),
    int_level_v     varchar2(1000),
    sem_density_s   varchar2(1000),
    sem_density_v   varchar2(1000),
    difficulty_s    varchar2(1000),
    difficulty_v    varchar2(1000),
    type_lrn_time   varchar2(200),
    type_lrn_time_l varchar2(100),
    type_lrn_time_s varchar2(1000)
);
...
create sequence ims_md_educational_lrt_seq start with 1;
...
create index ims_md_ed_lrt_imd_md_id_idx on ims_md_educational_lrt (ims_md_id);
...
create sequence ims_md_educational_ieur_seq start with 1;
...
create table ims_md_educational_ieur (
    ...
    ims_md_id           integer
                        ...
                        references ims_md(ims_md_id)
                        on delete cascade,
    ieur_s              varchar2(1000),
    ieur_v              varchar2(1000)
);

-- create index for ims_md_educational_ieur
create index ims_md_ed_ieur_imd_md_id_idx on ims_md_educational_ieur (ims_md_id);
...
create sequence ims_md_educational_context_seq start with 1;
...
create table ims_md_educational_context (
    ...
    ims_md_id           integer
                        ...
                        references ims_md(ims_md_id)
                        on delete cascade,
    context_s           varchar2(1000),
    context_v           varchar2(1000)
);

-- create index for ims_md_educational_context
create index ims_md_ed_cont_imd_md_id_idx on ims_md_educational_context (ims_md_id);
...
create sequence ims_md_educational_tar_seq start with 1;
...
create index ims_md_ed_tar_imd_md_id_idx on ims_md_educational_tar (ims_md_id);
...
create sequence ims_md_educational_lang_seq start with 1;
...
create index ims_md_ed_lang_imd_md_id_idx on ims_md_educational_lang (ims_md_id);
...
-- create seq from ims_md_educational_lrt table
create sequence ims_md_educational_descrip_seq start with 1;
...
create table ims_md_rights (
    ims_md_id       integer
                    ...
                    primary key,
    cost_s          varchar2(1000),
    cost_v          varchar2(1000),
    caor_s          varchar2(1000),
    caor_v          varchar2(1000),
    descrip_l       varchar2(100),
    descrip_s       varchar2(1000)
);
...
create sequence ims_md_relation_seq start with 1;
...
create table ims_md_relation (
    ...
    ims_md_id       integer
                    ...
                    references ims_md(ims_md_id)
                    on delete cascade,
    kind_s          varchar2(1000),
    kind_v          varchar2(1000)
);

-- create index for ims_md_relation
create index ims_md_re_imd_md_id_idx on ims_md_relation (ims_md_id);
...
create sequence ims_md_relation_resource_seq start with 1;
...
create index ims_md_re_res_imd_md_re_id_idx on ims_md_relation_resource (ims_md_re_id);
...
create sequence ims_md_rel_resource_cat_seq start with 1;
...
create sequence ims_md_annotation_seq start with 1;
...
create table ims_md_annotation (
    ...
    ims_md_id           integer
                        ...
                        on delete cascade,
    entity              varchar2(1000),
    annotation_date	varchar2(200),
    date_l              varchar2(100),
    date_s              varchar2(1000)
);

-- create index for ims_md_annotation
create index ims_md_an_imd_md_id_idx on ims_md_annotation (ims_md_id);
...
create sequence ims_md_annotation_descrip_seq start with 1;
...
create sequence ims_md_classification_seq start with 1;
...
create table ims_md_classification (
    ...
    ims_md_id           integer
                        ...
                        references ims_md(ims_md_id)
                        on delete cascade,
    purpose_s           varchar2(1000),
    purpose_v           varchar2(1000)
);

-- create index for ims_md_annotation
create index ims_md_cl_imd_md_id_idx on ims_md_classification (ims_md_id);
...
create sequence ims_md_classification_desc_seq start with 1;
...
create sequence ims_md_classif_taxpath_seq start with 1;
...
create table ims_md_classification_taxpath (
    ...
    ims_md_cl_id        integer
                        ...
                        references ims_md_classification(ims_md_cl_id)
                        on delete cascade,
    source_l            varchar2(100),
    source_v            varchar2(1000)
);

-- create index for ims_md_classification_taxpath
create index ims_md_cl_tax_imd_md_cl_id_idx on ims_md_classification_taxpath (ims_md_cl_id);
...
create sequence ims_md_classif_tpath_taxon_seq start with 1;
...
create sequence ims_md_classif_keyword_seq start with 1;
...
create index ims_md_cl_key_imd_md_cl_id_idx on ims_md_classification_keyword (ims_md_cl_id);
